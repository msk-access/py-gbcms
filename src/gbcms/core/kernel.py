...
from gbcms.models.core import GenomicInterval, Variant, VariantType
...
class CoordinateKernel:
    ...
    @staticmethod
    def vcf_to_internal(chrom: str, pos: int, ref: str, alt: str, original_id: str | None = None) -> Variant:
        """
